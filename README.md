...
Diversi ambiti della linguistica, tra cui l’analisi del discorso e delle metafore concettuali, sono stati applicati allo studio della comunicazione medica, evidenziando alcune tra le caratteristiche linguistiche tipiche dell’interazione tra medico e paziente. In medicina, più che in altri contesti specialistici, la lingua si è rivelata particolarmente efficace non solo come strumento 
migliorare sia la percezione del rapporto medico-paziente e la percezione del paziente nel contesto healthcare, sia di rendere più chiara e comprensibile l’interazione, e quindi “colmare il gap” tra linguaggio specialistico medico e non-specialistici. A titolo esemplificativo riporto il lavoro di Elena Semino, docente di linguistica presso l’università di Lancaster sull’applicazione di strumenti di linguistica dei corpora per l’analisi di linguaggio metaforico in diversi contesti sanitari.

- **come**: Analisi delle metafore concettuali utilizzate da pazienti terminali, loro caregivers (generalmente familiari) e professionisti del settore sanitario in un corpus costituito da 1,5 milioni di parole. Il corpus è stato creato a partire da interviste medico-paziente e dati raccolti dai forum online. I dati sono stati analizzati utilizzando il software W-Matrix.
- **risultati**: Vengono evidenziate due tipologie diffuse di metafore utilizzate: le metafore “di violenza”: generalmente metafore belliche, in cui la malattia viene concettualizzata come guerra e le metafore “del viaggio”, considerate sotto certi aspetti più positive rispetto alle prime (dipende dal tipo di viaggio usato per descrivere l’esperienza della malattia: per alcuni pazienti può trattarsi di “un’avventura epica” da condividere con gli altri malati, per altri di un “viaggio all’inferno”). Le metafore belliche, d’altra parte, possono offrire al paziente uno stimolo a reagire, essere dunque di supporto motivazionale; oppure, al contrario, generare frustrazione e un senso di impotenza derivante dalla sconfitta. 
...
## Come svolgere un’attività su doccano
...
1. Collegarsi al sito seguendo [questo link](http://doccano.fem.digital/)
